...
public class JourneyServiceTest {
        ...
        @Autowired
        JourneyService cityBikeJourneyService;
        ...
        void filterValidJourneyTest() {
                ...
                List<Journey> allTestJourneys = cityBikeJourneyService.buildCityBikeJourneyObj(cityBikeJourneys);

                assertEquals(2, cityBikeJourneyService.filterValidJourney(allTestJourneys).size(), "valid journey");
        }
